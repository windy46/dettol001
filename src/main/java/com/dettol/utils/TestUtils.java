...
//                while(j >= 0){
    ...
    private static void insert100(int[] array){
        int i = 0;
        while(array != null && ++i < array.length){
            for (int j = i; j > 0 && array[j - 1] > array[j] ; j--) {
                int value = array[j];
    ...
    private static void insert101(int[] array){
    ...
    private static void insert102(int[] array){
        for (int i = 0, value, j ; array != null && i < array.length; i++) {
            for (j = i, value = array[i]; j > 0 && array[j - 1] > value; j--) {
                array[j] = array[j - 1];
            }
            array[j] = value;
            printOut(array);
    ...
    private static void insert103(int[] array){
        int i = 1;
        while(array != null && i < array.length){
            int j = i, value = array[i++];
            while(j > 0 && array[j - 1] > value){
                array[j] = array[j-- - 1];
            }
            array[j] = value;
    ...
    private static void insert104(int[] array){
        int i = 0;
        while(array != null && ++i < array.length){
            int j = i;
            int value = array[i];
    ...
    private static void insert105(int[] array){
        if(array != null){
            int i = 0, j = i, value = array[i];
            while(i < array.length){
                while(j > 0 && array[j - 1] > value){
                    array[j] = array[j - 1];
                    j--;
    ...
    private static void insert106(int[] array){
        if(array != null){
            int value, i = 0;
            while(i < array.length) {
                value = array[i];
    ...
    private static void insert107(int[] array){
        if(array != null){
            int i = 0, j, value;
            while((j = i) < array.length){
                value = array[i++];
                while((j = j - 1) >= 0 && array[j] > array[j + 1]){
                        array[j + 1] = array[j];
                        array[j] = value;
                        value = array[j];
                }
    ...
    private static void insert108(int[] array){
        int i = 0, j, value;
        while(array != null && (j = i++) < array.length - 1){
            value = array[i];
            while(!(j < 0) && array[j] > value){
                array[j + 1] = array[j];
                j--;
